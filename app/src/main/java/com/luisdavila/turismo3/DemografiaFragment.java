...
public class DemografiaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MarkerOptions marker = new MarkerOptions().position(
                new LatLng(8.759186, -75.885283)).title("Montería").snippet("Colombia");
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(new LatLng(8.759186, -75.885283), 10);
